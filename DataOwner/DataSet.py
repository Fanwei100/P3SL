"""Dataset loading and per-client partitioning (data-owner side).

Provides :func:`getDataSet`, the helper that loads one of the supported
torchvision datasets (CIFAR-10/100, Fashion-MNIST, Flowers-102) and returns
the slice belonging to a particular client according to the configured
IID / non-IID partitioning scheme. Multiple IID modes are supported,
including the Dirichlet partitioner implemented in :mod:`Dirichlet_Partition`.
"""
